...
std::vector<std::string> damageTypes = {
    "Fire",     "Water",    "Rock",  "Air",       "Ice", "Lightning", "Grass",

    "Piercing", "Slashing", "Blunt", "Explosive",
...
std::unordered_map<std::string, std::unordered_set<std::string>>
    effectiveDamageToEnemyMap = {{"Fire",
                                  {
                                      "Ice",
                                      "Grass",
                                  }},
...
std::unordered_map<std::string, std::unordered_set<std::string>>
    ineffectiveDamageToEnemyMap = {{"Fire",
                                    {
                                        "Water",
                                        "Rock",
                                    }},
