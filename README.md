<!-- # Heaven-Hell
2D top-down RPG game with custom Entity Component System (ECS) and more!
-->
...
The general Visual Studio Code setup guide can be found here: https://code.visualstudio.com/docs/cpp/config-mingw

Install CMake (Windows x64 Installer): https://cmake.org/download/

Download and extract relevant SDL2 dependencies to a sibling folder named "SDL2" and extract the VC download inside.
